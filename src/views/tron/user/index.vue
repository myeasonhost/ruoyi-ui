  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类型" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择类型：0.正常,1.禁用,2离职" clearable size="small">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="id" v-if="false"/>
      <el-table-column label="代理ID" align="center" prop="agencyId" />
      <el-table-column label="用户名" align="center" prop="username" />
      <el-table-column label="昵称" align="center" prop="nicename" />
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, exportUser } from "@/api/tron/user";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          { required: true, message: "类型：0.正常,1.禁用,2离职不能为空", trigger: "blur" }
        ],
        remark: [
